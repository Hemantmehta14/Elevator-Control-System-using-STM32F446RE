...
#define floor1_GPIO_Port GPIOA
#define floor2_Pin GPIO_PIN_5
#define floor2_GPIO_Port GPIOA
#define floor3_Pin GPIO_PIN_6
#define floor3_GPIO_Port GPIOA
#define floor4_Pin GPIO_PIN_7
#define floor4_GPIO_Port GPIOA
#define idle_Pin GPIO_PIN_4
#define idle_GPIO_Port GPIOC
#define door_open_Pin GPIO_PIN_5
#define door_open_GPIO_Port GPIOC
#define moving_s_Pin GPIO_PIN_0
#define moving_s_GPIO_Port GPIOB
